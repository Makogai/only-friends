                ...
                <div class="w-[580px] pt-4 pl-4">
                    <div class="flex">
                        ...
                        <div class="text-white  pl-4">
                            <p class="pt-2"><Link :href="route('users.show', post.user.id)"> {{ post.user.name }}</Link> </p>
            ...
            <div v-else-if="post.image">
                ...
                <div class="w-[580px] pt-4 pl-4">
                    ...
                    <div class="w-[430px] ml-16 mt-4">
                        ...
                        <div class="text-white text-center mb-4 mt-3">
                            <img :src="'storage/'+post.image" alt="" class="flex object-fill rounded-2xl w-full img-glow" style="object-fit:cover">
            ...
            <div v-else>
                ...
                <div class="w-[580px] pt-4 pl-4">
                    ...
                    <div class="w-[430px] ml-16 mt-4">
                        ...
                        <div class="text-white text-center mb-4 mt-3">
                            <video :src="'storage/'+post.video" class="flex object-fill rounded-2xl w-full img-glow"  controls autoplay style="object-fit:cover"></video>
