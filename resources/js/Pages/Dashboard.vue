    ...
    <div v-for="post in posts" class="mt-5 grid grid-cols-1 place-items-center">
      <div v-if="post.text">
          ...
          <div class="w-[580px] pt-4 pl-4">
            <div class="flex">
              <div class="h-16 w-16">
                <img class="h-full w-16 rounded-full test"
                  src="https://images.pexels.com/photos/10839163/pexels-photo-10839163.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                  alt="">
              </div>
              <div class="text-white  pl-4">
                <p class="pt-2"> Kathryn Murphy </p>
